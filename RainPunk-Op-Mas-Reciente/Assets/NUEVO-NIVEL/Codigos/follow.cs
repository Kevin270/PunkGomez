    ...
    private void Update()
    {
        if (policia)//El boleano que controla todo lo del policia
        {
            ...
            else
            {
                ...
                else if (roundTime >= 2 && roundTime < 8)//Si en contador es mayor o igual a 2 y menor hara lo siguiente.
                {
                ...
                else if (roundTime >= 6)//Indica la distancia limite del patrullaje 
                {
                    roundTime = -2;
                }
            }           
